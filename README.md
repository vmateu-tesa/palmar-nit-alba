...
- **Cero backend transaccional**: los datos viven en `data/schedule.json` (programa), `data/official-palmeras.json` (listado oficial 2026) y `data/status.json` (avisos en vivo: retrasos e incidencias).
