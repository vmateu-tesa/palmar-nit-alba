...
(function () {
  const DICT = {
    va: {
      ...
      'mypalm.created': "Palmera creada! Generant la targeta per a compartir…",
      ...
      'fw.cta': "Veure en 3D",
      'fw.height': "Alçada aprox.",
      'fw.type.palmera': "Palmera de foc",
      'fw.type.coheta': "Cohetà",
      'fw.type.carcasses': "Càrregues aèries",
    ...
    cas: {
      ...
      'mypalm.created': "¡Palmera creada! Generando la tarjeta para compartir…",
      'mypalm.share_btn': "Compartir",
      'mypalm.delete': "Eliminar",
      'mypalm.card_kicker': "Nit de l'Alb\u00E0 \u00B7 Elx",
      ...
      'fw.cta': "Ver en 3D",
      'fw.height': "Altura aprox.",
      'fw.type.palmera': "Palmera de foc",
      'fw.type.coheta': "Cohetà",
      'fw.type.carcasses': "Cargas aéreas",
