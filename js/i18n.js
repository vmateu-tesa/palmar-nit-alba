...
(function () {
  const DICT = {
    va: {
      ...
      'add.free_note': "Esta palmera és gratuïta ({n} de {total} gratis).",
      'cd.live': "És la Nit de l'Albà!", 'cd.live_tap': "Toca per veure el cel en directe ✦",
    ...
    cas: {
      ...
      'add.free_price': "Gratis", 'add.publish_free': "Publicar gratis",
      'add.free_note': "Esta palmera es gratuita ({n} de {total} gratis).",
      'cd.live': "¡Es la Nit de l'Albà!", 'cd.live_tap': "Toca para ver el cielo en directo ✦",
