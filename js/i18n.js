...
(function () {
  const DICT = {
    va: {
      ...
      'mypalm.email': "El teu email",
      'mypalm.email_ph': "elteu@correu.com",
      'mypalm.email_note': "No es mostra a ningú. Només serveix per a poder contactar-te si cal moderar el contingut.",
      'mypalm.need_email': "Cal un email vàlid per a publicar la palmera.",
      ...
      'mypalm.created': "Palmera creada i publicada per a tots! 🎆",
      'mypalm.pending_note': "Es publica a l'instant per a tots els usuaris. L'organització es reserva el dret d'eliminar-la si no és adequada.",
      ...
      'alert.now': "Ara: {name}",
      'official.notify.soon': "En {min} min: {count} palmeres oficials ({range}) · {time}",
      'official.notify.now': "Ara: {count} palmeres oficials ({range}) · {time}",
      ...
      'map.legend.official_palmeres': "Palmeres oficials 2026",
      'map.pending': "Ubicació exacta per confirmar amb l'Ajuntament",
      'official.tag': "Palmera oficial",
      'official.type.municipal': "Ajuntament d'Elx",
      'official.type.association': "associació o col·lectiu",
      'official.type.official_public': "patrocini publicat",
      'official.time': "Hora oficial",
      'official.source_pdf': "PDF oficial de Fiestas en Elche",
      'official.approx': "Punt aproximat del lloc oficial: el PDF no publica coordenades GPS exactes.",
    ...
    cas: {
      ...
      'mypalm.email': "Tu email",
      'mypalm.email_ph': "tu@correo.com",
      'mypalm.email_note': "No se muestra a nadie. Solo sirve para poder contactarte si hace falta moderar el contenido.",
      'mypalm.need_email': "Hace falta un email válido para publicar la palmera.",
      ...
      'mypalm.created': "¡Palmera creada y publicada para todos! 🎆",
      'mypalm.pending_note': "Se publica al instante para todos los usuarios. La organización se reserva el derecho de eliminarla si no es adecuada.",
      'mypalm.share_btn': "Compartir",
      'mypalm.delete': "Eliminar",
      'mypalm.card_kicker': "Nit de l'Alb\u00E0 \u00B7 Elx",
      ...
      'official.notify.soon': "En {min} min: {count} palmeras oficiales ({range}) · {time}",
      'official.notify.now': "Ahora: {count} palmeras oficiales ({range}) · {time}",
      'notify.enable': "Activar avisos",
      ...
      'map.legend.official_palmeres': "Palmeras oficiales 2026",
      'map.pending': "Ubicación exacta por confirmar con el Ayuntamiento",
      'official.tag': "Palmera oficial",
      'official.type.municipal': "Ayuntamiento de Elche",
      'official.type.association': "asociación o colectivo",
      'official.type.official_public': "patrocinio publicado",
      'official.time': "Hora oficial",
      'official.source_pdf': "PDF oficial de Fiestas en Elche",
      'official.approx': "Punto aproximado del lugar oficial: el PDF no publica coordenadas GPS exactas.",
